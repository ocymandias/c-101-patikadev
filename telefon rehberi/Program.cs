...
namespace Proje_1
{
    ...
    class KisiIslemler
    {
        ...
        public void isimSoyisimAraması(string gelen)
        {
            ...
            if (!kayitVarmi)
            {
                islemSonucuIsle("Sonuç bulunamadı.");
            }
        }
        ...
        public void numaraSil(int index)
        {
             ...
             islemSonucuIsle("Silme İşlemi Gerçekleştirildi.");
        }
        public void numaraGuncelle(int index,string yeniTelefon)
        {
            kisiler[index].telefon = yeniTelefon;
            islemSonucuIsle("Güncelleme İşlemi Gerçekleştirildi.");
        }
    ...
    class Program
    {
        ...
        {
            List<Kisi> kisiler = new List<Kisi>();
            kisiler.Add(new Kisi("ahmet","mehmet","478"));
            kisiler.Add(new Kisi("can","cem","583"));
            kisiler.Add(new Kisi("ayşe","fatma","813"));
